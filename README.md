...
#### Usage
    ...
    CONFIG_FILE=inventory/mycluster/inventory.yaml python3 contrib/inventory_builder/inventory.py ${IPS[@]}
    ...
    ansible-playbook -i inventory/mycluster/inventory.yaml --become --become-user=root cluster.yml
